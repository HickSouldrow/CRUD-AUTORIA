...
<head>
    ...
    <title>Cadastrar Autorias</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100">
    <div class="w-full h-12 bg-green-600"></div>
    <div class="container mx-auto mt-8">
        <h1 class="text-4xl font-bold text-center text-gray-800 mb-8">Relação de Autorias Cadastradas</h1>
        <form name="cliente" method="POST" action="" class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
            <fieldset id="a" class="mb-4">
                <legend class="text-xl font-semibold mb-4"><b>Dados das Autorias:</b></legend>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input name="txtdatalancamento" type="text" placeholder="yyyy/mm/dd" class="w-full px-3 py-2 border border-gray-300 rounded">
                </div>
                <div class="mb-4">
                    <label for="txteditora" class="block mb-2">Editora:</label>
                    <input name="txteditora" type="text" placeholder="Editora" class="w-full px-3 py-2 border border-gray-300 rounded">
                </div>
            </fieldset>
        ...
        if (isset($btnenviar)) {
            ...
            $pro->setDataLancamento($txtdatalancamento);
