...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-8">
        <h1 class="text-4xl font-bold text-center text-gray-800 mb-8">Alteração de Autor Cadastrados</h1>
        
     
        <div class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
        <form name = "autoria" method = "POST" action = "ClasseAlterarAutor2.php">                <fieldset id="a" class="mb-4">
